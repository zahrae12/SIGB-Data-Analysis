...
Ingénierie (ETL) : Nettoyage et migration via Python (Pandas) vers PostgreSQL.
...
├── scripts/            # Script Python de migration et ETL
├── model/              # Schémas MCD et MLD du projet
├── report/             # Rapport complet du projet (PDF)
...
PostgreSQL configuré localement.

Power BI Desktop.

2. Configuration
Crée un fichier .env à la racine du projet avec tes identifiants :
...
Active ton environnement virtuel et lance le script d'ETL :
...
Répartition géographique et campus : Analyse comparative BUA/BUF.

Analyses tendancielles : Top 10 des matières et auteurs, et évolution temporelle des acquisitions.
